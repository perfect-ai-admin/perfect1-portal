...
6️⃣ SECTION 6: HUMAN_VOICE (סקשן שישי בדיוק)
{
  ...
  "items": [
    {"type": "testimonial", "content": "ציטוט לקוח משכנע, 2-3 משפטים", "author": "שם אמין", "role": "בעל עסק בתחום"},
    {"type": "founder_message", "content": "מסר מייסד אישי, 2-3 משפטים", "author": "שם מייסד", "role": "מייסד/ת"},
    {"type": "customer_story", "content": "סיפור אנושי עמוק, 2-3 משפטים", "author": "שם לקוח", "role": "לקוח"}
  ]
}
⚠️ MUST: בדיוק 3 items בדיוק בסדר הזה: testimonial (item 1) → founder_message (item 2) → customer_story (item 3)

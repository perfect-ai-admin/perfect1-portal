...
6️⃣ SECTION 6: HUMAN_VOICE (סקשן שישי בדיוק)
{
  "type": "human_voice",
  ...
  "items": [
    {
      "type": "testimonial", 
      "content": "ציטוט של לקוח שמרוצה - אנושי, ספציפי וקונקרטי (3-4 משפטים). צריך להוות הוכחה שהפתרון עובד בפועל. למשל: 'בשנה האחרונה החסכנו כמה אלפים בשכרים, הלקוחות שלנו יותר מרוצים, וסוף סוף יש לי זמן לעצמי.'", 
      "author": "שם לקוח אמין (שם פשוט, קרדיבל)", 
      "role": "בעל עסק / מנהל / משכיר"
    },
    {
      "type": "founder_message", 
      "content": "מסר מייסד אישי עמוק - למה אתה כאן, מה המטרה שלך, מה הדרך שלך (3-4 משפטים). צריך להיות משכנע וגנואיני. למשל: 'בנית את השירות הזה כי בעצמי סבלתי מ... וחשבתי שאתה בטח גם סובל. היום אני גאה שיוצאים הרבה מעסקים רווחיים בעזרתי.'", 
      "author": "שם המייסד (שם קצר קרדיבל)", 
      "role": "מייסד / בעל העסק"
    },
    {
      "type": "customer_story", 
      "content": "סיפור קצר של לקוח - ספציפי וחיוני (3-4 משפטים). מה היה לפני? מה קרה? מה בחזק עכשיו? למשל: 'התחלתי עם 2 לקוחות, עכשיו יש לי 25. הרווחים שלי התחלפו משלושה ספרות לארבע ספרות. זה לא היה אפשרי בלי הכלים הנכונים.'", 
      "author": "שם לקוח אמיתי שנראה קרדיבל", 
      "role": "לקוח / בעל עסק / עצמאי"
    }
  ]
}
⚠️ MUST: בדיוק 3 items בסדר הזה: testimonial (עדות לקוח) → founder_message (מסר מייסד) → customer_story (סיפור לקוח)
⚠️ CRITICAL: כל content צריך להיות ספציפי, קונקרטי ואנושי - לא כללי! קלט מייצר דוגמאות משכנעות שמעוררות אמון

      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-2xl w-full max-w-md sm:max-w-lg max-h-[100vh] sm:max-h-[95vh] overflow-y-auto"
          >
            {/* Close Button */}
            <button
              onClick={handleClose}
            ...
            {/* Content - Compact */}
            <div className="p-3 sm:p-4 max-h-[calc(100vh-120px)] sm:max-h-[calc(95vh-90px)] overflow-y-auto">

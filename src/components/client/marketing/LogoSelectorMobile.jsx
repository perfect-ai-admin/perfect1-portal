...
export default function LogoSelectorMobile({ logos, formData }) {
  ...
  return (
    <div className="lg:hidden w-full h-screen flex flex-col bg-white overflow-hidden">
      ...
      >
        <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl flex items-center justify-center shadow-sm w-60 h-60">
          <img 
            src={currentLogo.url} 
        ...
        {/* Variant Name */}
        <h3 className="text-sm font-bold text-gray-900 mt-4">{currentLogo.variant}</h3>
      ...
      <div className="px-4 pb-4 space-y-3 flex-shrink-0">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button 
            ...
            className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 text-sm font-semibold rounded-xl shadow-md flex items-center justify-center gap-2 transition-colors"
          >
          ...
          <button 
            ...
            className="w-full border-2 border-gray-300 text-gray-700 py-3 text-sm font-semibold rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
          >
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="w-full py-3 px-2 rounded-xl border border-gray-300 text-gray-700 text-sm font-semibold disabled:opacity-30 disabled:cursor-not-allowed hover:bg-gray-50 transition-all flex items-center justify-center gap-1"
          >
          ...
          <button
            ...
            className="w-full py-3 px-2 rounded-xl border-2 border-blue-300 text-blue-700 text-sm font-semibold disabled:opacity-30 disabled:cursor-not-allowed bg-blue-50 hover:bg-blue-100 transition-all flex items-center justify-center gap-1"
          >
            הבא

    ...
    return (
      <div className="flex flex-col h-full bg-gray-50">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          <div className="flex-1 flex flex-col p-2 sm:p-4 space-y-3 overflow-y-auto">
            {/* Iframe Preview with Watermark Overlay */}
            <div className="bg-white rounded-xl shadow-lg overflow-hidden border-2 border-gray-200 relative min-h-[70vh] sm:min-h-[600px]">
              <iframe
                src={embedUrl}
                className="w-full h-full min-h-[70vh] sm:min-h-[600px] border-0"
              ...
              <div className="absolute inset-0 pointer-events-none z-20">
                ...
                <div
                  className="absolute text-red-500/25 font-black text-4xl sm:text-6xl md:text-8xl whitespace-nowrap select-none"
                  style={{
                    top: '20%',
                    left: '50%',
              ...
              {/* Info banner */}
              <div className="absolute bottom-0 left-0 right-0 bg-yellow-50/95 backdrop-blur-sm border-t-2 border-yellow-200 px-3 py-2 text-center">
                <p className="text-xs text-yellow-800 font-semibold">
                  💡 גלול בין השקפים • לאחר תשלום תקבל PDF נקי
                </p>
              </div>
            </div>

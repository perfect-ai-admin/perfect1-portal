        ...
        <div className="flex-1">
          <div className="flex items-start justify-between gap-2 mb-1.5">
            ...
            <button
              ...
              className="px-2 py-1 md:px-3 md:py-1.5 bg-white/20 hover:bg-white/30 rounded-md transition-all flex items-center gap-1 md:gap-2 flex-shrink-0"
            >
              <HelpCircle className="w-3 h-3 md:w-4 md:h-4" />
              <span className="text-[10px] md:text-xs font-medium">למה?</span>
            </button>
          </div>

  ...
  const handleCreateGoal = async (newGoal, isEditing = false) => {
     try {
       ...
       if (isEditing) {
          ...
          // Remove ID if it's a timestamp generated by template, let DB assign or keep if UUID
          // But GoalTemplates uses Date.now().toString() which is fine for key, but for DB maybe let it generate?
          // Or use the one we generated. UserGoal entity structure allows ID? usually yes.
          // Let's just pass the object, base44 sdk handles it.
          // We need to ensure user_id is set
       ...
       setShowAddGoal(false);
        ...
        // Fallback optimistic update if needed, or show error
     }
   };

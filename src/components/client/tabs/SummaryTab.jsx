...
import { Rocket, Brain, Zap, Award, Target, TrendingUp, Users, Crown, Shield, Sparkles, Star, ChevronLeft } from 'lucide-react';
    ...
    >
      ...
      <Card className="p-6 md:p-8 border border-gray-200 bg-white">
        <div className="space-y-4">
          ...
          <Button
            onClick={() => {
              // TODO: trigger navigation to goals tab in parent
              window.dispatchEvent(new CustomEvent('navigateTab', { detail: { tab: 'goals' } }));
            }}

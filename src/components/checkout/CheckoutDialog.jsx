...
function SummaryStep({ product, amount, user, iframeLoading, onProceed }) {
  return (
    <div className="space-y-4">
      ...
      {/* Payment methods - all wallets available for one-time */}
...
function PaymentStep({ product, amount, user, handshakeData, onBack, onManualConfirm }) {
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Digital wallet quick-pay buttons */}
      <div className="space-y-2">

  ...
  return (
    <>
      ...
      <SEOOptimized
        ...
        description="ליווי חודשי לעוסק פטור עם אפליקציה, דיווחים לרשויות, וגישה לרו"ח. השאר פרטים וקבל ייעוץ חינם."
        keywords="ליווי חודשי עוסק פטור, מעקב הכנסות הוצאות, דיווחים לרשויות, רו"ח עוסק פטור"

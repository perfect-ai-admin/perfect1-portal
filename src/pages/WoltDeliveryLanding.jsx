...
import { CheckCircle, MessageCircle, Phone, Zap, Clock, Shield, Users, Bike, FileText, TrendingUp } from 'lucide-react';
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a href="tel:0502277087" className="w-full sm:w-auto">
                <Button size="lg" className="w-full sm:w-auto h-16 px-8 text-lg font-bold rounded-full bg-white text-[#00C2E8] hover:bg-gray-50 shadow-2xl hover:scale-105 transition-transform">
                  <Phone className="w-6 h-6 ml-2" />
                  התקשר עכשיו: 050-227-7087
                </Button>
              </a>
            </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <motion.div
                ...
                className="bg-white p-6 rounded-2xl border-2 border-gray-200 hover:border-[#00C2E8] transition-colors shadow-sm"
              >

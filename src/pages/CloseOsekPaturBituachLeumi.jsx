  ...
  const faqs = [
    {
      ...
      answer: "ביטוח לאומי ימשיך לחייב בדמי ביטוח כל חודש. בנוסף, יכולים להיות קנסות על عدم דיווח, ודרישות להחזר דמים שנגבו בטעות."
    },
    {
    ...
    },
    {
      ...
      answer: "זה תלוי בסכום החוב. אתה יכול להתחיל בתהליך סגירה גם עם חובות, אבל צריך לתיאם עם הביטוח לאומי תוכנית תשלום."
    },
    {
    ...
    },
    {
      ...
      answer: "לא בהכרח. הביטוח הבריאות שלך כתלוי בביטוח לאומי עצמו. כשתשלים דמי סיום, צריך לדאוג לעצמך לביטוח חדש דרך קופת חולים."
    }
  ];
  ...
  const scenarios = [
    {
      ...
      desc: 'העוסק שלך סיים בטבעי והכל מסודר.',
      steps: [
    ...
    },
    {
      ...
      steps: [
        'הודעה לביטוח לאומי (חובות לא יעצרו את הסגירה)',
        'תיאום תוכנית תשלום עם הביטוח לאומי',
        'סיום שאר התיקים (מס הכנסה, מע״מ)',
        'סגירה סופית לאחר סיום כל החוקים'
      ],
      time: '4-6 שבועות',
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    desc: 'מס הכנסה לא יסגור את התיק שלך עד שביטוח לאומי יודיע שהוא סגור. זה תנאי קדום.'
                  },
                  {
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  ...
                  { issue: '❌ דמים שלא שולמו', solution: 'יכול להיות עם תוכנית תשלום, אבל צריך לתאם' },
                  { issue: '❌ טעויות בדיווח הכנסה', solution: 'צריך תיקון רטרואקטיבי עם הביטוח' },
                  { issue: '❌ חוקים ממסים אחרים חד-צדדיים', solution: 'צריך לסגור עם מס הכנסה והמע״מ קודם' }
                ].map((item, i) => (
                  <motion.div
                    key={i}
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    desc: 'אם יש דיווחים שנתיים חסרים, תיקן אותם כראשית במה מס הכנסה ניתן להסכים.'
                  },
                  {
                    num: '4',
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
                מס הכנסה, מע״מ, מנהל תאגידים - כל אחד יש צעדים של שלו. אם תרצה תמונה מלאה של הסגירה הנכונה:
              </p>

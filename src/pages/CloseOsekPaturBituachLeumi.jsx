...
export default function CloseOsekPaturBituachLeumi() {
  ...
  const faqs = [
    ...
    {
      question: "מה קורה לדמי ביטוח שכבר שולמתי בעודף?",
      answer: "אם שילמת דמים יותר מדי לביטוח לאומי, אתה זכאי להחזר. ביטוח לאומי בדרך כלל משלם את ההחזרים בתוך 2-4 שבועות מאישור הסגירה."
    }
  ];
  ...
  const scenarios = [
    {
      ...
      steps: [
        ...
        'קבלת אישור סגירה מהביטוח לאומי',
        'ביטוח לאומי משלם את הדמים שנגבו בעודף (אם יש)',
        'פתיחת ביטוח חדש כעובד או כחופשי'
      ],
      time: '2-3 שבועות',

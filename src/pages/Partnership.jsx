          ...
          <section>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-purple-300 rounded-lg p-6">
                <h4 className="font-bold text-xl text-purple-900 mb-4">📊 סוף שנה 3 - תיק קיים (500 פטורים בלבד)</h4>
                <div className="space-y-3">
                  <div className="bg-white p-4 rounded">
                    <div className="flex justify-between items-center">
                      <span className="font-semibold">הכנסות שנתיות:</span>
                  ...
                  <div className="bg-white p-4 rounded">
                    <div className="flex justify-between items-center">
                      <span className="font-semibold">רווח תפעולי שנתי (57% רווחיות):</span>
                      <span className="text-xl font-bold text-purple-600">613,000 ₪</span>
                    </div>
                  </div>
                  <div className="bg-white p-4 rounded">
                    <div className="flex justify-between items-center">
                      <span className="font-semibold">כפולת שווי (×5):</span>
                      <span className="text-2xl font-bold text-purple-600">3,065,000 ₪</span>
                    </div>
                  </div>
                  <div className="bg-purple-600 text-white p-4 rounded">
                    <div className="flex justify-between items-center">
                      <span className="font-bold text-lg">שווי לשותף (50%):</span>
                      <span className="text-3xl font-bold">1,532,500 ₪</span>
                    </div>
                  </div>
                </div>
              </div>

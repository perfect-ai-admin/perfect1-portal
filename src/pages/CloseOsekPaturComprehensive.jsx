            ...
            >
              ...
              <div className="space-y-6">
                {[
                  {
                    step: 1,
                    title: 'בדיקת כל ההתחייבויות',
                    desc: 'בדוק אם יש חובות משכנתאות, הלוואות, או חוב לרשויות. זה הצעד הראשון לפני כל דבר.'
                  },
                  {
                    step: 2,
                    title: 'הגשת דוח שנתי סופי',
                    desc: 'אם עדיין לא הגשת דוח לשנה האחרונה - זה חובה. הוא חייב להגיע ל-מס הכנסה לפני סגירה.'
                  },
                  {
                    step: 3,
                    title: 'הודעה למס הכנסה על סגירה',
                    desc: 'מלא טופס סגירת עוסק ושלח למס הכנסה. זה יכול להיעשות אונליין דרך אתר מס הכנסה.'
                  },
                  {
                    step: 4,
                    title: 'סגירה של מע״מ (אם היית בחיוב)',
                    desc: 'אם הרשמת את העוסק למע״מ - צריך גם לסגור את החשבון שם. דוח מע״מ אחרון, החזר יתרה.'
                  },
                  {
                    step: 5,
                    title: 'סגירה של ביטוח לאומי',
                    desc: 'הודעה על סיום עסקות לביטוח לאומי. תשלום כל החיוקים הנותרים עד לחודש הסגירה.'
                  },
                  {
                    step: 6,
                    title: 'קבלת אישור סופי',
                    desc: 'כשכל הרשויות סגרו את הקבצים שלך - אתה יכול להיות רגוע שהסגירה הושלמה.'
                  }
                ].map((item, i) => (
                  <motion.div
                    key={i}
            ...
            >
              ...
              <div className="space-y-6">
                {[
                  ...
                  {
                    icon: Clock,
                    title: 'חוסר תעדוך כלשהו',
                    desc: 'שמור את כל ההודעות והאישורים מהרשויות. זה עשוי להיות חשוב בעתיד.'
                  },
                  {
                    icon: FileText,
                    title: 'לא תיקנת חוקים בעת הסגירה',
                    desc: 'אם היית חייב בביטוח לאומי - תשלם קנסות וריבית אם לא תשלם בעת הסגירה.'
                  }
                ].map((item, i) => (
                  <motion.div
                    key={i}

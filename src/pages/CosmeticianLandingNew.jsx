...
export default function CosmeticianLandingNew() {
  ...
  const handleSubmit = async (e) => {
    ...
    const message = `היי, אני ${formData.name} - קוסמטיקאית, מעוניינת לפתוח עוסק פטור. טלפון: ${formData.phone}`;
  ...
  return (
    <>
      <SEOOptimized
        title="פתיחת עוסק פטור לקוסמטיקאיות 2026 - המדריך המלא + ליווי מקצועי"

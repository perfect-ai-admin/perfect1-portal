  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await invokeFunction('submitLeadToN8N', {
        name: form.name,
        phone: form.phone,
        pageSlug: `steps-osek-patur-b-${variant}`,
        businessName: 'שלבי פתיחת עוסק פטור B',
      });
      navigate('/ThankYou', { state: { source: `steps-osek-patur-b-${variant}`, name: form.name, fromForm: true } });
    } catch {
...
// ============================
// Main Page — Version B (Google Ads compliant)
// ============================
export default function OsekPaturStepsB() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'עם ליווי מקצועי — בין שעה ליום עסקים אחד. רוב הרישומים מאושרים באותו יום שבו שולחים את הבקשה. תוך 24 שעות מקבלים אישור סופי.',
    },
    {
      question: 'אני יכול לפתוח לבד חינם — למה שאעבוד איתכם?',
      answer: 'בהחלט אפשר לפתוח לבד. אבל 1 מכל 3 עוסקים שפותחים לבד עושים טעות בבחירת קוד ענף, ברישום, או בבחירת הסטטוס — טעות שעלולה לעלות אלפי שקלים לתקן. אנחנו מוודאים שהכל מדויק מההתחלה.',
    },
    {
    ...
    },
    {
      ...
      answer: 'עוסק פטור מתאים להכנסות עד כ-120,000 שקלים בשנה ופטור מחיובים נוספים ללקוחות. עוסק מורשה מתאים להכנסות גבוהות יותר וחייב בדיווחים תקופתיים ובניהול ספרים מסודרים. אם אתם בתחילת הדרך — כמעט תמיד כדאי להתחיל כעוסק פטור.',
    },
    {
      question: 'האם עוסק פטור משלם תשלומים חודשיים?',
      answer: 'כן. עוסק פטור הוא עצמאי לכל דבר ומשלם דמי רישום חודשיים לפי הכנסתו. יש לפתוח תיקים בכל הרשויות תוך שבוע מפתיחת העסק — וזה בדיוק אחד מהדברים שאנחנו דואגים לו כשאתם איתנו.',
    },
    {
      question: 'מה קורה אם אני חורג מתקרת ההכנסות?',
      answer: 'כשהמחזור עובר את תקרת הפטור (כ-120,000 שקלים), חובה לעבור לעוסק מורשה תוך 30 יום. התהליך פשוט יחסית וגם בזה נעזור לכם כשהעסק יגדל.',
    },
    {
  ...
  const steps = [
    {
      num: '01',
      title: 'רישום ופתיחת תיקים ברשויות',
      body: 'פותחים תיק עצמאי ורושמים אתכם בכל הגורמים הנדרשים. ניתן לעשות אונליין או בסניף. אנחנו מגישים את הטפסים עבורכם בצורה מדויקת.',
      icon: FileText,
    },
    {
      num: '02',
      title: 'הסדרת תשלומים חודשיים',
      body: 'תוך שבוע מפתיחת העסק חובה לפתוח תיקים ולהסדיר תשלומים שוטפים. שלב שרבים שוכחים — ואצלנו הוא נעשה אוטומטית.',
      icon: Shield,
    },
    {
      num: '03',
  ...
  const mistakes = [
    { title: 'לא לפתוח תיקים בכל הרשויות', desc: 'פותחים תיק אחד אבל שוכחים את השאר — ונצברים קנסות מיותרים.' },
    { title: 'לא לשמור קבלות מההתחלה', desc: 'ללא קבלות אי אפשר לנכות הוצאות — משלמים יותר בסוף השנה ללא סיבה.' },
  ...
  const withUs = [
    ...
    { label: 'רישום בכל הרשויות', detail: 'כל התיקים נפתחים בבת אחת' },
    ...
    <div dir="rtl" className="bg-white min-h-screen font-sans">
      ...
      >
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 py-10 md:py-20 text-center">
          ...
          <p className="text-white/85 text-[16px] sm:text-lg md:text-xl leading-relaxed mb-6 max-w-2xl mx-auto">
            כל מה שצריך לדעת על פתיחת תיקים ורישום ברשויות — וגם רו״ח שעושה את כל העבודה בשבילכם, תוך יום עסקים.
          </p>
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4 md:p-5 mb-7 text-right max-w-2xl mx-auto">
            <p className="text-white/90 text-[15px] md:text-base leading-[1.7]">
              <strong className="text-green-300">בקצרה:</strong> פתיחת עוסק פטור חינמית ונעשית אונליין תוך 10-15 דקות. דרושים ת.ז., כתובת עסק, והערכת הכנסות שנתית עד 120,000 שקלים. השלבים: רישום ופתיחת תיקים בכל הרשויות הנדרשות.
            </p>
          </div>
      ...
      <div
        className={`md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-200 shadow-[0_-4px_12px_rgba(0,0,0,0.08)] transition-transform duration-300 ${
          showSticky && !modalOpen ? 'translate-y-0' : 'translate-y-full'
        }`}
      ...
      <Dialog open={modalOpen} onOpenChange={setModalOpen}>
        <DialogContent
          mobileSheet
          className="sm:max-w-md rounded-t-3xl sm:rounded-3xl p-0 overflow-hidden border-0"
          dir="rtl"
        >
          <div className="bg-gradient-to-br from-green-600 to-green-700 text-white px-5 py-4 sm:p-6 text-center">
            <DialogHeader>
              <DialogTitle className="text-white text-[20px] sm:text-[22px] font-extrabold mb-0.5 text-center">
                מעולה! בואו נתחיל
              </DialogTitle>
              <DialogDescription className="text-white/90 text-[13px] sm:text-[14px] text-center">
          ...
          <div className="px-5 py-4 sm:p-6">
            ...
            <div className="mt-3 pt-3 sm:mt-4 sm:pt-4 border-t border-gray-100 text-center">
              <p className="text-gray-500 text-[12px] mb-1.5">מעדיפים לשאול קודם?</p>
              <a
                href={WHATSAPP_URL}
                target="_blank"
                rel="noopener noreferrer"

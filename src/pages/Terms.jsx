            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-8 md:p-12 space-y-8">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  אתר זה, הפועל בכתובת perfect-dashboard.com, מופעל על ידי חברת פרפקט וואן, ח.פ 516309747 (להלן: "החברה" או "הנהלת האתר"). השימוש באתר ובשירותיו כפוף לקריאת תקנון זה ולהסכמה לתנאיו. בעצם השימוש באתר, הגלישה בו, והזמנת שירותים או מוצרים באמצעותו, הנך מצהיר/ה כי קראת את התקנון, הבנת אותו ואת/ה מסכימ/ה לכל הוראותיו.
                </p>

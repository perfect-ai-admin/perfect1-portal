  ...
  const faqs = [
    {
      ...
      answer: "צריך להודיע למס הכנסה בתוך 30 ימים מיום הסגירה. זה לא רק דרישה, זה מחייב."
    },
    {
      question: "איזה דוח צריך להגיש סופי?",
      answer: "דוח שנתי סופי המראה הכנסות עד תאריך הסגירה. זה חייב להגיע למס הכנסה בטופס 3011."
    },
    {
                ...
                {[
                  {
                    ...
                    title: 'דוח שנתי סופי (טופס 3011)',
                    desc: 'הדוח האחרון שלך שמראה את כל ההכנסות עד תאריך הסגירה. זה חובה וצריך להגיש אותו לפני סגירה סופית.'
                  },
                  {
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  { 
                    name: 'טופס הודעה על סיום עסקות',
                    code: 'טופס 2062',
                    details: 'תיאור: הודעה רשמית למס הכנסה על סיום העסקות.\nמתי: בתוך 30 ימים מיום הסגירה.\nאיך: ניתן להגיש דרך אתר מס הכנסה או דרך רואה חשבון.'
                  },
                  { 
                    name: 'דוח שנתי סופי',
                    code: 'טופס 3011',
                    details: 'תיאור: מציג את ההכנסות, הוצאות, והרווח נטו עד לתאריך הסגירה.\nמתי: לפני סגירה סופית.\nחשוב: צריך לכלול רק הכנסות עד תאריך הסגירה בדיוק.'
                  },
                  { 
                    name: 'דוח מע״מ סופי',
                    code: 'דוח מע״מ אחרון',

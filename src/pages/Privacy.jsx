            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-8 md:p-12 space-y-8">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  מדיניות פרטיות זו מתארת את האופן שבו חברת פרפקט וואן, ח.פ 516309747 (להלן: "החברה", "אנחנו") אוספת, משתמשת, מאחסנת ומגנה על מידע אישי של המשתמשים באתר perfect1.co.il ובשירותיה. מדיניות זו מנוסחת בהתאם לחוק הגנת הפרטיות, התשמ"א-1981, ובפרט בהתאם לתיקון מס' 13 לחוק (2025), ולתקנות הגנת הפרטיות (אבטחת מידע), התשע"ז-2017.
                </p>

  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="bg-gradient-to-br from-[#2C5282] via-[#3B6BA8] to-[#1E3A5F] text-white py-16 md:py-24 relative overflow-hidden mt-20">
        ...
        <section className="bg-[#F8F9FA] py-12 md:py-16">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-3 gap-6">
                {[
                  { title: 'לקוחות מחכים לחשבונית', desc: 'בלי חשבונית רשמית, לקוח עסקי לא יוכל להוציא הוצאה משפטית', icon: '⏰' },
                  { title: 'חובה משפטית', desc: 'אם אתה רשום למע״מ או יש לך לקוח עסקי - חשבונית היא חובה חוקית', icon: '⚖️' },
                  { title: 'שמירת רישומים', desc: 'חוק דורש שמירה של כל חשבוניות למשך 3-4 שנים כדי להימנע מבעיות משפטיות', icon: '📋' }
                ].map((item, i) => (
                <motion.div
                  key={i}
          ...
          {/* Main Content */}
            ...
            <section className="bg-gradient-to-r from-[#27AE60] to-[#2ECC71] text-white rounded-2xl p-8 md:p-12 text-center">
              ...
              <p className="text-white/95 mb-8 text-lg max-w-3xl mx-auto">
                ...
                או 
                <Link to={createPageUrl('MonthlyReportOsekPatur')} className="underline hover:opacity-80 font-black mx-1">קבל ליווי מלא</Link>
                - בדיוק מה שצריך לך.
              </p>

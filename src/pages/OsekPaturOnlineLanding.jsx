  ...
  return (
    <>
      ...
      <LocalBusinessSchema 
        ...
        description="שירות ייעוץ וליווי מקצועי בתהליך פתיחת עוסק פטור אונליין"
        address={{
          street: "",
          city: "",
          country: "ישראל"
      ...
      <SEOOptimized
        ...
        schema={{
          ...
          "description": "שירות ייעוץ וליווי מקצועי בתהליך פתיחת עוסק פטור",
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="inline-flex items-center gap-2 bg-yellow-400/20 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-yellow-400/40">
                  <span className="text-yellow-400 text-sm font-bold">⚠️ שירות ייעוץ וליווי - Perfect One Ltd.</span>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-4">
                    <p className="text-sm text-gray-700 leading-relaxed">
                      <strong className="text-blue-800">הבהרה חשובה:</strong> זהו שירות ייעוץ וליווי - Perfect One Ltd., חברה עצמאית. תהליך אישור הרשויות (מס הכנסה, ביטוח לאומי) תלוי בעיבוד שלהן ולא בשלנו.
                    </p>
                  </div>
                </form>
              </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4">
              {[
              {
                q: 'מה כל כך בטוח בשירות שלכם?',
                a: 'אתה מדבר עם אדם אמיתי שיודע את התהליך, לא עם רובוט. אנחנו בודקים את כל הנתונים קודם, ומסבירים בבירור מה קורה עם הרשויות.'
              },
              {
                q: 'כמה זה עולה?',
                a: 'לפרטים על עלויות, השאר פרטים וידברו אתך ישירות על המחיר המתאים לך.'
              },
              {
                q: 'כמה זמן לוקח הרשויות לאשר?',
                a: 'זה תלוי במס הכנסה וביטוח לאומי. יכול להיות כמה ימים עד מספר שבועות. אנחנו מעקבים והמנו עדכונים.'
              },
              {
                q: 'איזה מסמכים צריכים?',
                a: 'בדרך כלל: תעודת זהות, אישור בנק, כמה פרטים של העסק. בייעוץ הראשוני נספר לך בדיוק.'
              },
              {
                q: 'מה ההבדל בין פטור למורשה?',
                a: 'פטור = פטור ממס הכנסה, לא צריך ספרים. מורשה = צריך לנהל ספרים ודו"חות. אנחנו עוזרים לשניהם.'
              },
              {
                q: 'איך מתחילים?',
                a: 'אתה משאיר פרטים בטופס הזה, יועץ שלנו חוזר אליך בוואטסאפ וטלפון, ומשם אנחנו מתכננים ביחד.'
              }
              ].map((faq, i) => (

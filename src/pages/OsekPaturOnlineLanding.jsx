              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                  ...
                  <a href="https://wa.me/972502277087?text=היי, רוצה לפתוח עוסק פטור אונליין" target="_blank" rel="noopener noreferrer">
                    <Button variant="outline" className="w-full sm:w-auto h-12 sm:h-14 px-4 sm:px-8 text-base sm:text-lg font-bold rounded-xl border-2 border-white bg-white text-[#3498DB] hover:bg-white/90 shadow-lg">
        ...
        <section className="py-12 bg-gradient-to-br from-[#F8F9FA] to-blue-50/30">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { icon: Smartphone, title: 'מילוי טופס מקוון', desc: 'כל הפרטים נמלאים בצורה נוחה מהנייד או מהמחשב' },
                { icon: FileText, title: 'העלאת מסמכים דיגיטלית', desc: 'צילום תעודת זהות ואישור בנק - ישירות מהטלפון' },
                { icon: Lock, title: 'חתימה דיגיטלית מאובטחת', desc: 'חתימה דיגיטלית מוכרת חוקית על כל המסמכים' },
                { icon: Users, title: 'ליווי צמוד בתהליך', desc: 'ליווי מקצועי לאורך כל שלבי הפתיחה' },
                { icon: Monitor, title: 'תהליך מקוון לחלוטין', desc: 'הכל מתבצע אונליין - בלי לצאת מהבית' },
                { icon: CheckCircle, title: 'הגשה מסודרת לרשויות', desc: 'אנחנו דואגים שהכל יוגש נכון למס הכנסה וביטוח לאומי' }
              ].map((item, i) => (
                <motion.div
                  key={i}
                  initial={{ opacity: 0, y: 20 }}

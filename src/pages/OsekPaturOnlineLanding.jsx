...
export default function OsekPaturOnlineLanding() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "השירות כולל: ליווי מלא בתהליך הפתיחה, מילוי טפסים דיגיטלי, חתימה אלקטרונית מאובטחת, בדיקת נכונות כל הפרטים, והגשה מסודרת לרשויות (מס הכנסה וביטוח לאומי)."
    },
    {
    ...
    },
    {
      ...
      answer: "פתיחה אונליין חוסכת זמן ונסיעות - אין צורך להגיע פיזית לשום מקום. התהליך נוח יותר (מהבית), מהיר ובטוח לחלוטין."
    },
    {
    ...
    },
    {
      ...
      answer: "האישורים ממס הכנסה, מע\"מ וביטוח לאומי מגיעים למייל שלך. הזמן תלוי בעיבוד הרשויות, אך יועצנו מטפל בכל ההליך ויעדכן אותך בכל שלב."
    },
    {
        ...
        <section className="py-12 bg-gradient-to-br from-[#F8F9FA] to-blue-50/30">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
               {[
                 { icon: FileText, title: 'שלב 1: מילוי הנתונים', desc: 'אתה ממלא את הטופס דרך הממשק שלנו - שם, כתובת, סוג עסק ומספרים בנקאיים' },
                 { icon: Smartphone, title: 'שלב 2: העלאה וצילום', desc: 'צילום ת.ז., אישור בנק ודוק נוסף - הכל דרך האפליקציה, מאובטח לחלוטין' },
                 { icon: Lock, title: 'שלב 3: חתימה דיגיטלית', desc: 'חתימה אלקטרונית בטוחה על כל המסמכים - מוכרת חוקית בכל רשות' },
                 { icon: Zap, title: 'שלב 4: הגשה וטיפול', desc: 'אנחנו שולחים הכל ישר למס הכנסה וביטוח לאומי ודואגים שנעבוד נכון' },
                 { icon: CheckCircle, title: 'שלב 5: מעקב מלא', desc: 'אתה מקבל עדכונים בכל תנועה - המערכות שלך מעתה מתפקדות בהצלחה' },
                 { icon: Users, title: 'בכל רגע: סיוע מקצועי', desc: 'אם יש שאלה, יועץ שלנו זמין בווצאפ או טלפון בזריז לעזור' }
               ].map((item, i) => (
                <motion.div
                  key={i}
                  initial={{ opacity: 0, y: 20 }}

...
📅 ${new Date().toLocaleString('he-IL')}`;
  ...
  return (
    <>
      <SEOOptimized
        title="פתיחת עוסק פטור אונליין - פשוט, מהיר וחוקי | Perfect One"
        description="פתיחת עוסק פטור בליווי מלא, בלי בירוקרטיה ובלי התעסקות. אנחנו פותחים לך עוסק פטור, מטפלים מול הרשויות ומלווים אותך בכל שלב. התחל לעבוד חוקי עכשיו! 0502277087"
        keywords="פתיחת עוסק פטור, פתיחת עוסק פטור אונליין, איך לפתוח עוסק פטור, רואה חשבון לפתיחת עוסק, פתיחת תיק עוסק פטור, עוסק פטור לעצמאי חדש"

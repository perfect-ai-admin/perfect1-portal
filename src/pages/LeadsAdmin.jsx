          ...
          {sortedLeads.map((lead) => (
            <div key={lead.id} className="bg-white rounded-lg shadow-md p-3 border-r-4" style={{
              ...
              <div className="flex gap-2">
                ...
                <a
                  href={`https://wa.me/972559700641?text=${encodeURIComponent(`היי ${lead.name}, אני מפרפקט one. ${lead.profession ? `ראיתי שאת/ה ${lead.profession}` : 'נעים להכיר'} - איך אפשר לעזור לך?`)}`}
                  target="_blank"

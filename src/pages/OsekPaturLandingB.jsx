...
function LeadForm({
  ...
  title,
  subtitle,
  ctaText = 'בדיקת התאמה לפתיחת עוסק פטור',
  className = '',
}) {
  ...
  const trackEvent = (eventName, data = {}) => {
    ...
    if (window.fbq) {
      window.fbq('track', eventName === 'lead_submitted' ? 'Lead' : 'CustomEvent', {
        content_name: 'osek_patur_landing_b',
        ...data,
      });
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await invokeFunction('submitLeadToN8N', {
        name: form.name,
        phone: form.phone,
        pageSlug: `landing-osek-patur-b-${variant}`,
        businessName: `דף נחיתה B - landing-osek-patur-b-${variant}`,
      });

      navigate('/ThankYou', { state: { source: `landing-osek-patur-b-${variant}`, name: form.name, fromForm: true } });
    } catch (err) {
        ...
        >
          {loading ? (
            ...
            <>
              ...
              <span className="sm:hidden">בדיקת התאמה חינם</span>
            </>
          )}
        </Button>
      </form>
...
function LandingSchemaMarkup({ faqItems }) {
  const serviceSchema = {
    ...
    description: 'ליווי מקצועי לפתיחת עוסק פטור בישראל — בדיקת התאמה, הכוונה למסמכים, וליווי בתהליך הרישום.',
    provider: {
      '@type': 'Organization',
      name: 'פרפקט וואן',
    ...
    availableChannel: {
      '@type': 'ServiceChannel',
      serviceUrl: 'https://perfect1.co.il/OsekPaturLandingB',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'פתיחת עוסק פטור', item: 'https://perfect1.co.il/OsekPaturLandingB' },
    ],
  };
...
// ============================
// Main Landing Page — Version B (Google Ads compliant)
// ============================
const FAQ_ITEMS = [
  {
    question: 'מה זה עוסק פטור?',
    answer: 'עוסק פטור הוא מעמד המיועד לעצמאים עם הכנסה שנתית עד 120,000 שקלים (נכון ל-2026). במעמד זה אתם פטורים מגבייה נוספת, מניהול ספרים כפול, ומדיווחים מורכבים. זה המעמד הפשוט ביותר להתחלת עבודה עצמאית בישראל.',
  },
  {
  ...
  {
    question: 'האם חייבים להגיע פיזית למשרדים?',
  ...
  },
  {
    ...
    answer: 'בהחלט! הרבה שכירים פותחים עוסק פטור במקביל כדי לקבל הכנסות צדדיות באופן חוקי. זה נפוץ מאוד ולגיטימי לחלוטין.',
  },
  {
    question: 'מה ההבדל בין עוסק פטור לעוסק מורשה?',
    answer: 'עוסק פטור פטור מחיובים ודיווחים מורכבים, אבל מוגבל בתקרת הכנסות. עוסק מורשה יכול לקזז הוצאות ואין מגבלת הכנסות. אנחנו נבדוק מה מתאים לכם.',
  },
  {
...
export default function OsekPaturLandingB() {
  ...
  return (
    <>
      <div dir="rtl" className="portal-root min-h-screen" style={{ fontFamily: "'Heebo', sans-serif" }}>
        {/* SEO Head */}
        <Helmet>
          <title>פתיחת עוסק פטור | ליווי מקצועי מהתחלה ועד הסוף - פרפקט וואן</title>
          <meta name="description" content="רוצים לפתוח עוסק פטור? קבלו ליווי מקצועי מלא — בדיקת התאמה חינם, רישום מסודר, הכוונה לכל השלבים. בלי בירוקרטיה, בלי טעויות. התחילו עכשיו!" />
          <meta name="keywords" content="פתיחת עוסק פטור, איך פותחים עוסק פטור, פתיחת עוסק פטור אונליין, עוסק פטור למתחילים, רישום עוסק פטור" />
          <link rel="canonical" href="https://www.perfect1.co.il/OsekPaturLandingB" />
          <meta property="og:title" content="פתיחת עוסק פטור — ליווי מקצועי מא׳ ועד ת׳" />
          <meta property="og:description" content="בדיקת התאמה חינם לפתיחת עוסק פטור. ליווי מקצועי, בלי בירוקרטיה, בלי טעויות." />
          <meta property="og:type" content="website" />
          <meta property="og:url" content="https://www.perfect1.co.il/OsekPaturLandingB" />
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
              ...
              <div className="order-1 md:order-1">
                ...
                <p className="text-lg md:text-xl text-white/85 mb-6 leading-relaxed max-w-lg">
                  נפתח לך את כל התיקים הנדרשים — במהירות, בצורה מסודרת ובלי טעויות.
                </p>
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                { icon: AlertTriangle, text: 'לא ברור מה לפתוח קודם ואיפה בכלל מתחילים', color: 'text-red-500' },
                { icon: Clock, text: 'חוששים לבזבז ימים שלמים על בירוקרטיה ותורים', color: 'text-orange-500' },
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="space-y-4 md:space-y-0 md:grid md:grid-cols-4 md:gap-4">
              {[
                ...
                { num: '3', title: 'רישום וטיפול ברשויות', desc: 'אנחנו מטפלים בכל הצד הבירוקרטי', color: 'bg-portal-teal' },
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {[
                ...
                'הכוונה לרישום בכל הגורמים הנדרשים',
                'הכנת מסמכים והגשה מסודרת',
                'ליווי מול כל הרשויות הרלוונטיות',
                'רשימת מסמכים נדרשים',
          ...
          <div className="max-w-4xl mx-auto px-4">
            <div className="bg-white rounded-xl p-5 border-r-4 border-amber-500">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                ...
                האתר אינו אתר ממשלתי ואינו קשור לגורם רשמי כלשהו.
            ...
            <div className="grid md:grid-cols-3 gap-6 text-right mb-8">
              <div>
                ...
                <p className="text-white/60 text-sm leading-relaxed">
                  ליווי עסקי מקצועי לפתיחת עוסק פטור, עוסק מורשה וחברות. מאות עסקים שנפתחו בהצלחה.
                </p>
              </div>

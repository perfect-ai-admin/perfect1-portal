...
export default function OsekPaturSteps() {
  ...
  return (
    <>
      ...
      />
      <SEOOptimized
        title="פתיחת עוסק פטור – 5 שלבים מסודרים | אונליין"
        description="מדריך פתיחת עוסק פטור ב־5 שלבים מול הרשויות בישראל. הסבר ברור, טעויות נפוצות וקישור לפתיחת עוסק פטור אונליין בתהליך מסודר."
        keywords="פתיחת עוסק פטור, 5 שלבים, איך פותחים עוסק פטור, תהליך פתיחה, מס הכנסה, ביטוח לאומי"

...
export default function OsekPaturSteps() {
  ...
  const steps = [
    { title: 'בדיקה זכאות', description: 'בדיקה אם אתה זכאי לעוסק פטור' },
    { title: 'הכנת מסמכים', description: 'איסוף כל המסמכים הדרושים' },
    { title: 'הגשה למס הכנסה', description: 'הגשת הבקשה למס הכנסה' },
    { title: 'רישום בביטוח לאומי', description: 'רישום וביטוח לאומי אוטומטי' },
    { title: 'קבלת אישור', description: 'קבלת מספר ארגון וסיום התהליך' }
  ];

  return (
    <>
      <SEOOptimized
        title="פתיחת עוסק פטור – 5 שלבים קריטיים | Perfect One"
        description="כל שלב בפתיחת עוסק פטור מסודר ובהיר. מה לעשות בכל שלב ומה צריך להיות מוכן."
          ...
          >
            ...
            <div className="space-y-6 mb-16">
              {steps.map((step, i) => (
                <motion.div
                  ...
                  className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-6 border-r-4 border-blue-600"
                >
            ...
            <div className="bg-blue-600 text-white rounded-3xl p-8 md:p-12 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 mb-6">
                ...
                >
                  {isSubmitting ? 'שולח...' : 'קבל ליווי אישי'}
                </Button>
              </form>

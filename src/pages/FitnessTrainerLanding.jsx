...
import { CheckCircle, Phone, MessageCircle, Dumbbell, Shield, Clock, TrendingUp } from 'lucide-react';
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
                  ...
                  <span className="text-white/90 text-sm font-medium">מתמחים במאמנים</span>
                </div>

                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight mb-6">
                  מאמן כושר?
                  <br />
                  <span className="text-[#27AE60]">פותחים לך עוסק תוך דקות</span>
                </h1>

                <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed font-medium">
                  פתיחת עוסק למאמנים אישיים אונליין, עם ליווי מלא ובלי בירוקרטיה.
                  <br />
                  <strong className="text-[#D4AF37]">תתחיל לאמן חוקית תוך 24-72 שעות!</strong>
                </p>

                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
                  <a href="https://wa.me/972502277087?text=היי, אני מאמן כושר ואשמח לפתוח עוסק פטור" target="_blank" rel="noopener noreferrer">
              ...
              >
                <LeadForm
                  title="💪 מאמן? בוא נפתח לך עוסק!"
                  subtitle="מלא פרטים ונחזור אליך תוך שעות"
                  defaultProfession="מאמן כושר"
                  sourcePage="דף נחיתה - מאמן כושר"
                  variant="card"
                  compact={true}
                />
              </motion.div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-black text-[#1E3A5F] mb-6">
                השאלות שכל מאמן כושר שואל
              </h2>
            </motion.div>

            <div className="grid md:grid-cols-2 gap-4">
              {[
                'איך פותחים עוסק כמאמן כושר?',
                'עוסק פטור או מורשה למאמן אישי?',
                'צריך רואה חשבון למאמן כושר?',
                'איך מוציאים קבלות למתאמנים?'
              ].map((q, i) => (
                <motion.div
                  key={i}
                  initial={{ opacity: 0, y: 20 }}
            ...
            >
              <p className="text-2xl font-black text-[#27AE60]">
                אנחנו מטפלים בכל זה בשבילך – בצורה פשוטה, חוקית ומהירה
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="space-y-4">
                  {[
                    { icon: CheckCircle, text: 'פתיחת עוסק פטור למאמני כושר', color: 'text-[#27AE60]' },
                    { icon: Shield, text: 'טיפול מלא מול מס הכנסה, מע"מ וביטוח לאומי', color: 'text-[#1E3A5F]' },
                    { icon: TrendingUp, text: 'ליווי אישי והסברים ברורים', color: 'text-[#D4AF37]' },
              ...
              >
                ...
                <ul className="space-y-4">
                  {[
                    'פתיחת תיק עוסק פטור',
                    'התאמה מלאה למאמן כושר / מאמן אישי',
                    'ליווי מקצועי וזמין',
                    'הסבר מה מותר ומה אסור לדווח',
        ...
        <section className="py-16 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                'ניסיון בליווי מאמני כושר ועצמאים',
                'התמחות בפתיחת תיקים לעסקים קטנים',
                'שירות אישי, ברור וזמין',
                'דגש על פשטות, שקיפות ושקט'
              ].map((text, i) => (
                <motion.div
                  key={i}
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-black text-white mb-6">
                רוצה להתחיל לאמן חוקי כבר השבוע?
              </h2>
              <p className="text-xl text-white/80 mb-8">
                השאר פרטים ונחזור אליך תוך שעות
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="https://wa.me/972502277087?text=היי, אני מאמן כושר ואשמח לפתוח עוסק" target="_blank" rel="noopener noreferrer">

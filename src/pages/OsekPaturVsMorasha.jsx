...
import {
  CheckCircle, AlertCircle, Phone, MessageCircle, Clock,
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">
                יש מקצועות שלא יכולים להתנהל כעוסק פטור – חייבים מיד עוסק מורשה. זה לא בחירה – זה דרישה משפטית.
              </p>
            </motion.div>
            ...
            >
              <h3 className="text-2xl font-bold text-[#1E3A5F] mb-4">למה זה חשוב? 🤔</h3>

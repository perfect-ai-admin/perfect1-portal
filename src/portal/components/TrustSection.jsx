...
// framer-motion removed — CSS animation instead (saves 120KB from portal bundle)
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {items.map((item, index) => (
            <div
              key={index}
              className="text-center p-4 sm:p-6 rounded-2xl bg-portal-bg hover:shadow-md transition-all animate-fade-in-up"

...
export default function CategoryCard({ title, description, href, icon, color = 'teal', stats }) {
  ...
  return (
    <Link
      to={href}
      className={`group relative block rounded-2xl bg-gradient-to-br ${gradient} text-white p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden`}
    >

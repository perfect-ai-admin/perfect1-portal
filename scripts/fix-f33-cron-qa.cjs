// fix-f33-cron-qa.cjs — set cron to run in 2 minutes (UTC-based)
...
async function main() {
  ...
  console.log(`Setting cron to: ${qaCron}`);
  ...
  if (result.id) {
    ...
    console.log('Workflow will fire at UTC', qaHour + ':' + String(qaMin).padStart(2,'0'));
  } else {

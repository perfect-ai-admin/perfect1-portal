...
function discoverRoutes() {
  const routes = [];
  const categories = ['osek-patur', 'osek-murshe', 'hevra-bam', 'osek-zeir', 'sgirat-tikim', 'guides', 'misui', 'maam', 'miktzoa'];
...
const PUBLIC_PAGES_SEO = {
  ...
  '/OsekPaturLandingB': {
    title: 'פתיחת עוסק פטור | ליווי מקצועי מהתחלה ועד הסוף — פרפקט וואן',
    description: 'רוצים לפתוח עוסק פטור? קבלו ליווי מקצועי מלא — בדיקת התאמה חינם, רישום מסודר, הכוונה לכל השלבים. בלי בירוקרטיה, בלי טעויות.',
    keywords: 'פתיחת עוסק פטור, פתיחת עוסק פטור אונליין, רישום עוסק פטור',
    noindex: true,
  },
  '/OsekPaturSteps': {
  ...
  '/open-hevra-bam-online': {
    title: 'פתיחת חברה בע"מ אונליין — 450₪ | פרפקט וואן',
    description: 'פתחו חברה בע"מ אונליין ב-450₪. מלאו שאלון קצר, שלמו אונליין, ותעודת התאגדות תוך 7 ימים. רו"ח + עו"ד.',
    keywords: 'פתיחת חברה בע"מ, פתיחת חברה אונליין, הקמת חברה, חברה בע"מ 450',
  },
  '/blog/logo-leasek': {
